...
Only the [latest release](https://github.com/blancodagoat/DejaVu/releases/latest) is supported. There is no auto-updater, so please update manually before reporting.
